...
/**
 * Offline community rain. Meshloom OSS must not call Stats `/v1/live/packets`
 * until the backend stream workstream wires the proxy.
 */
export const LIVE_PACKET_FIXTURES: CommunityPacket[] = [
  {
    ...
    hop_count: 2,
    hops: [
      { token: 'ab12', lat: 45.76, lon: 4.84 },
      { token: 'cd34', lat: 45.74, lon: 4.92 },
    ],
    snr: -4.2,
    iata: 'LYS',
    t: 0,
  ...
  },
  {
    ...
    hop_count: 3,
    hops: [
      { token: '11aa', lat: 45.69, lon: 4.79 },
      { token: '22bb', lat: 45.71, lon: 4.88 },
      { token: '33cc', lat: 45.73, lon: 4.99 },
    ],
    snr: 6.5,
    iata: 'LYS',
    t: 0,
  ...
  },
  {
    ...
    hop_count: 2,
    hops: [
      { token: 'aa01', lat: 48.86, lon: 2.35 },
      { token: 'bb02', lat: 48.95, lon: 2.45 },
    ],
    snr: 1.2,
    iata: 'CDG',
    t: 0,
  ...
  },
  {
    ...
    path: ['99aa'],
    hop_count: 1,
    hops: [{ token: '99aa', lat: 46.2, lon: 6.14 }],
    iata: 'GVA',
    t: 0,
    ear_id: 'ear-gva-1',
  },
